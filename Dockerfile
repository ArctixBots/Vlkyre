...
RUN aptitude install -y jq git curl wget ffmpeg nodejs npm bpm-tools python3-pip opus-tools python-is-python3 && git clone https://github.com/Royce-B/Vlkyre.git
...
# RUN git config --global user.name "Royce-B" && git config --global user.email "bqwack@gmail.com"
